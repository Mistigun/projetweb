...
<script src="<?= RACINE ?>/PHP/image.js"></script>
 ...
 <section class="car-gallery">
        ...
        <div>
        <h1>Bugatti Chiron</h1><br>
        <h3>La Bugatti Chiron est une hypercar du constructeur automobile français Bugatti, descendante annoncée de la Bugatti Veyron 16.4[2]. Elle tient son nom du pilote automobile monégasque Louis Chiron (1899-1979)[3]. Elle est préfigurée par le concept car Bugatti Vision Gran Turismo et inspirée par la Bugatti Type 57. La Bugatti Chiron a été produite de 2016 à 2024, à 500 exemplaires, ce qui représente une production d'environ 60 exemplaires par an.</h3><br>
        <h2>W16</h2><br>

        <h2>Spécifications :</h2><br>
    
        <ul> <li>Cylindrée :W16</li>
        <li>Puissance thermique : 1500 ch</li>
        <li>0-100 km/h : 2.3 secondes</li>
        <li>Vitesse max : 400 km/h</li>
    ...
    <section class="car-gallery">
        ...
        <ul> <li>Cylindrée : 2.9L Biturbo</li>
        <li>Puissance thermique : 478 ch</li>
        <li>0-100 km/h : 3,7 secondes</li>
        <li>Vitesse max : 325 km/h</li>
    ...
    <section class="car-gallery">
        ...
        <h2>V12 Lamborghini</h2><br>

        <h2>Spécifications :</h2><br>
    
        <ul> <li>Cylindrée : 5.9l</li>
        <li>Puissance thermique : 455 ch</li>
        <li>0-100 km/h : 4.5 secondes</li>
        <li>Vitesse max : 306 km/h</li>
        <li>Transmission : Manuelle à 5 rapports  </li>
    </ul></div>
</main>
